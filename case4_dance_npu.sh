...
export VERL_DANCE_ENABLE_FINITE_CHECKS=${VERL_DANCE_ENABLE_FINITE_CHECKS:-1}
export VERL_DANCE_FAIL_ON_NONFINITE=${VERL_DANCE_FAIL_ON_NONFINITE:-1}
export VERL_DANCE_ENABLE_TRACE=${VERL_DANCE_ENABLE_TRACE:-0}
export VERL_DANCE_TRACE_LOG_ALL_STEPS=${VERL_DANCE_TRACE_LOG_ALL_STEPS:-0}
export VERL_DANCE_TRACE_PREVIEW_LIMIT=${VERL_DANCE_TRACE_PREVIEW_LIMIT:-8}
export VERL_DANCE_TRACE_DIR=${VERL_DANCE_TRACE_DIR:-./dance_case4_traces}
export VERL_DANCE_SANITIZE_EXPORT_VIDEO=${VERL_DANCE_SANITIZE_EXPORT_VIDEO:-0}
...
export VERL_DANCE_MATERIALIZE_CPU_BATCH_AFTER_TRANSFER=${VERL_DANCE_MATERIALIZE_CPU_BATCH_AFTER_TRANSFER:-0}
