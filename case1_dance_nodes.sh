...
REPORT_DIR=${REPORT_DIR:-/workspace/projects/long-rl/outputs/nodes_gpu/dance_case1_step_timing}
...
ray job submit --address="${RAY_ADDRESS}" \
  ...
  python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=dance_case1_nodes \
    trainer.experiment_name=case1_dance_nodes \
    trainer.nnodes=2 \
