...
import regex as re
import torch
from transformers import AutoTokenizer, ProcessorMixin, UMT5EncoderModel
...
class WanProcessor(ProcessorMixin):
    ...
    This processor handles text encoding for Wan video generation models using UMT5EncoderModel and AutoTokenizer.
    """
