...
CONFIG_NAME="${CONFIG_NAME:-config_video_diffusion_case3_dance_npu}"
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-case3_dance_npu_$(date +%Y%m%d_%H%M%S)}"
NNODES="${NNODES:-1}"
