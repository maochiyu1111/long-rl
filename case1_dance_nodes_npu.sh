...
REPORT_DIR=${REPORT_DIR:-/home/qzy/project/long-rl/outputs/nodes/dance_case1_step_timing}
...
ray job submit --address="${RAY_ADDRESS}" \
  ...
  python3 -m verl.trainer.main_ppo \
    ...
    --config-name=config_video_diffusion_case1_dance \
    hydra.job.chdir=false \
    trainer.project_name=dance_case1_nodes_npu \
    trainer.experiment_name=case1_dance_nodes_npu \
    trainer.device=npu \
    trainer.nnodes=2 \
    ...
    actor_rollout_ref.actor.extra.dance.actor_prompt_batch_count=1 \
