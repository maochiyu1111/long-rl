...
REPORT_DIR=${REPORT_DIR:-/home/qzy/project/long-rl/outputs/nodes/dance_case3_step_timing}
...
ray job submit --address="${RAY_ADDRESS}" \
  ...
  python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=dance_case3_nodes_npu \
    trainer.experiment_name=case3_dance_nodes_npu \
    trainer.device=npu \
    trainer.nnodes=2 \
